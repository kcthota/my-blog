...
(function() {
    const themeConfig = {"light":{"primary":"#222","secondary":"#666","background":"#ffffff","text":"#213547","border":"#eee","cardBackground":"#eee","linkHover":"#000","linkColor":"#3d6ab7ff","lifeWeek":"#ddd"},"dark":{"primary":"#fff","secondary":"#aaa","background":"#121212","text":"#e0e0e0","border":"#333","cardBackground":"#373636ff","linkHover":"#fff","linkColor":"#87c5ebff","lifeWeek":"#bbb"},"fontFamily":"Avenir, Open Sans, sans-serif"};
